...
class MainFrame(wx.Frame):
    ...
    COMMAND_PAUSEIME = 'IME:PAUSE'
    COMMAND_RESUMEIME = 'IME:RESUME'
    COMMAND_STOPIME = 'IME:STOP'
    COMMAND_STARTIME = 'IME:START'
    COMMAND_SHOWIME = 'IME:SHOW'
    COMMAND_HIDEIME = 'IME:HIDE'
    COMMAND_SAVEIME = 'IME:SAVE'
